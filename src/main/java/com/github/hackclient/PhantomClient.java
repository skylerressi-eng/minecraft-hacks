...
/**
 * Phantom Client — Fabric entrypoint (Minecraft 1.21.11).
 *
 * Design notes:
 ...
 *  - The open key (Right Shift) and the AutoBreachSwap key (V) are detected by
 *    polling GLFW directly. GLFW key codes are stable across versions, so this
 *    does not depend on intermediary/yarn/mojang name changes.
...
public class PhantomClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        instance = this;
        log("Phantom Client v" + VERSION + " initializing for Minecraft 1.21.11...");
    ...
    private void handleKeys(Minecraft client) {
        ...
        // Right Shift: toggle the GUI screen.
